<?php
$kayit = "";
if (array_key_exists ( "kayit", $_SESSION )) {
	$kayit = $_SESSION ['kayit'];
}
if ($kayit) {
}else{
				     ...
				     <div class='container'>
				        <div class='row'>
				           <div class='col-md-5'>
				              <!-- Logo -->
				              <div class='logo'>
				                 <h1><a href='index.php'>Hasta Kayıt Birimi</a></h1>
				              </div>
				           </div>
				           <div class='col-md-5'>
				              <div class='row'>
...
function getMenu(){
	return "
			<ul class='nav' style='display: block; background-color: '>
					...
					<li><a title='Bunun için yetkiniz yok'><i class='glyphicon glyphicon-user'></i> Doktor Görüntüle</a></li>
					<li><a title='Bunun için yetkiniz yok'><i class='glyphicon glyphicon-tasks'></i> Poliklinikler</a></li>
			<li class='submenu'>
                         <a title='Bunun için yetkiniz yok'>
                            <i class='glyphicon glyphicon-zoom-in'></i> Stok Durumu
                            <span class='caret pull-right'></span>
                         </a>
                         <!--Sub menu-->
                         <ul>
                            <li><a title='Bunun için yetkiniz yok'><i class='glyphicon glyphicon-minus'></i> İlaçlar</a></li>
                            <li><a title='Bunun için yetkiniz yok'><i class='glyphicon glyphicon-minus'></i> Tıbbi Malzeme</a></li>
                        </ul>
                    </li>		 
