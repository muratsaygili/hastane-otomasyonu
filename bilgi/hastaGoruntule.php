		  ...
		  <div class="col-md-10">
			...
			while ( $row = mysql_fetch_assoc ( $rs_result ) ) {
				...
				echo '<tr class="gradeA odd"> 
									<td class="  sorting_1"><strong>'.$row['kayit_no'].'</strong> <a href="hastaDetay.php?kayit_no='.$row['kayit_no'].'">Detay <i class="glyphicon glyphicon-search"></i> </td>';
