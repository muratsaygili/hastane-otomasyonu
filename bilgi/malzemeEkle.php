...
if($mod=="ekle"){
	...
	if(array_key_exists("mal_fiyat",$_POST))
		...
		$rsEkle=mysql_query("INSERT INTO stok (mal_ad,stok_adet,mal_fiyat) VALUES ('$ad','$stokAdet','$fiyat')",$db);
...
<div class='content-box-large'>
	...
	<div class='panel-body'>
		<form action='malzemeEkle.php' method='post'>
			<fieldset>
				...
				<div class='form-group'>
					<label>Malzeme Adı </label> <input required="required" name='mal_ad' maxlength="30"
						class='form-control' placeholder='Ad' type="text" >
				</div>
				<div class='form-group'>
